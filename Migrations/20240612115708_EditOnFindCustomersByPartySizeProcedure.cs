...
{
    /// <inheritdoc />
    public partial class EditOnFindCustomersByPartySizeProcedure : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                AS BEGIN 
                 SELECT Customers.CustomerId,Customers.Firstname,Customers.Lastname ,Customers.Email,Customers.PhoneNumber
